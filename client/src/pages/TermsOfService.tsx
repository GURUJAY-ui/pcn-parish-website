...
`;
  ...
  return (
    <LegalPageLayout
      ...
      description="These terms govern the use of the official digital platforms, services, media, donations, and communications of Presbyterian Church of Nigeria, First Abuja Parish."
    >
