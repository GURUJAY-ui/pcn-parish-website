export const siteContent = {
  about: {
    ...
    origin: {
      eyebrow: "Our Origins",
      title: "Rooted in the Reformation",
      paragraphs: [
    ...
    vision: "To be a Bible-based Church, proclaiming to the world by preaching and example, the good news of the love of God through Jesus Christ His Son under the guidance of the Holy Spirit.",
    mission: "To carry the gospel to all parts of Nigeria and beyond through evangelism, discipleship, service and promotion of social righteousness.",
    doctrines: [
  ...
  staff: {
    stats: [
      ...
      { label: "Committee Leads", value: "18", color: "text-cyan-400" },
      { label: "Service Areas", value: "Governance, Mission, Care", color: "text-emerald-400" },
    ],
    committees: [
      {
        id: 1,
      ...
      },
      {
        id: 3,
        name: "Medical",
        duties: ["Hospitals management", "Health insurance", "Health education", "Medical outreach", "Immunization", "First aid"],
      ...
      },
      {
        ...
        duties: ["Create and manage central FAP membership data and website", "Manage FAP-PCN presence on social media", "Promote digital skills development"],
  ...
  donations: {
    categories: [
      { id: "tithe", label: "Tithe", description: "A tenth of your increase unto the Lord", color: "from-amber-400 to-amber-600" },
      { id: "offering", label: "Offering", description: "Freewill offerings and donations", color: "from-cyan-400 to-cyan-600" },
      { id: "special-seed", label: "Special Seed", description: "Special seed sowing and faith offerings", color: "from-emerald-400 to-emerald-600" },
      { id: "building-fund", label: "Building Fund", description: "Support the church building project", color: "from-purple-400 to-purple-600" },
      { id: "missions", label: "Missions", description: "Support evangelism and missions work", color: "from-rose-400 to-rose-600" },
      { id: "covenant-seed", label: "Covenant Seed", description: "A special covenant seed offering to unlock blessings", color: "from-green-400 to-green-600" },
      { id: "education-trust-fund", label: "Education Trust Fund", description: "Support the funding of schools owned by the Parish", color: "from-blue-400 to-blue-600" },
    ],
    accounts: {
      ngn: [
        ...
        { bank: "UBA PLC", accountName: "Presbyterian Church of Nigeria - First Abuja Parish (Love & Care)", accountNumber: "1017515110", type: "CURRENT", flag: "NGN", label: "Naira - Love & Care" },
        { bank: "GTBank", accountName: "Presbyterian Church of Nigeria - First Abuja Parish (Evangelism & Missions)", accountNumber: "0024200913", type: "CURRENT", flag: "NGN", label: "Naira - Evangelism & Missions" },
        { bank: "Access Bank", accountName: "Presbyterian Church of Nigeria - First Abuja Parish (MCA)", accountNumber: "0021845681", type: "CURRENT", flag: "NGN", label: "Naira - MCA" },
        { bank: "Access Bank", accountName: "Presbyterian Church of Nigeria - First Abuja Parish (Trust Fund)", accountNumber: "0009052513", type: "CURRENT", flag: "NGN", label: "Naira - Trust Fund" },
        { bank: "Ecobank Nigeria Plc", accountName: "Presbyterian Church of Nigeria - First Abuja Parish (Project)", accountNumber: "0312008551", type: "CURRENT", flag: "NGN", label: "Naira - Project Account" },
      ],
      usd: [
        ...
        { bank: "UBA PLC", accountName: "Presbyterian Church of Nigeria - First Abuja Parish (Dollar)", accountNumber: "3003939332", type: "CURRENT", flag: "USD", label: "USD Dollar Account" },
      ],
      gbp: [
    ...
    heroSlides: [
      {
        ...
        cta1: { label: "Learn More", route: "/about" },
        cta2: { label: "Watch Live", href: "https://youtube.com/@pulpitfaptv" },
      },
      {
        id: 2,
        label: "Community",
        ...
        cta1: { label: "Visit Us", route: "/contact" },
        cta2: { label: "Our Story", route: "/about" },
      },
      {
        id: 3,
        label: "Grace",
        ...
        cta1: { label: "Our Mission", route: "/about" },
        cta2: { label: "Get Involved", route: "/ministries" },
      },
    ],
    digitalMinistries: [
  ...
  ministries: {
    mainMinistries: [
      { id: "worship", icon: "Music", style: "amber", name: "Worship Ministry", tagline: "Lifting His Name in Every Service", description: "Leading the congregation in Spirit-filled worship across all services - from the earliest morning gathering to the Teen & Children's Church.", convener: "Rev. Agan", units: ["First Service", "Second Service", "Fresh Anointing", "Mid Week Service", "Teen/Youth Church", "Children Church"], members: ["Eld. Dr. E. Nkang", "Eld. Dr. E. Asanga", "Eld. Dr. Nnachi Ibiam", "Eld. Mrs. Nkata", "Rev. Mrs. Onu", "Eld. Mike Oti"] },
      { id: "evangelism", icon: "Globe", style: "orange", name: "Evangelism, Discipleship & Follow Up Ministry", tagline: "Going Into All the World", description: "Active gospel outreach, systematic discipleship and diaspora engagement - taking the Word beyond the walls of the sanctuary.", convener: "Rev. Dr. U. Ukiwo", units: ["Evangelism & Missions", "Discipleship", "Diaspora"], members: ["Eld. Dr. A. K. Allotey", "Eld. Ikechukwu Okoro", "Eld. Allojoe Ayang"] },
      { id: "prayer", icon: "Star", style: "violet", name: "Prayer & Teaching Ministry", tagline: "The Intercession Engine of the Parish", description: "Fuelling every department through corporate and individual prayer, and grounding the congregation in deep, systematic Bible teaching.", convener: "Rev. Iyke Anaga", units: ["Prayer", "Teaching"], members: ["Eld. Mrs. Ijeoma Amanabu", "Eld. Mike Oti", "Eld. Iyke Okoro"] },
      { id: "music", icon: "Music", style: "pink", name: "Music Ministry", tagline: "Excellence in Every Note of Praise", description: "Five distinct choral and orchestral ensembles - from the Awesome Choir to the Church Orchestra - lifting worship to the highest standard.", convener: "Eld. Sam Etum", units: ["Awesome Choir", "Christ Anointed Singers", "Children Choir", "Teen Choir", "Church Orchestra"], members: ["Eld. Mrs. Dee Nkang", "Eld. Etum Ukpai", "Eld. Emmanuel Ononokpono", "Eld. Otu Ekpenyong", "Eld. Dr. E. Nkang"] },
      { id: "ushering", icon: "UserCheck", style: "cyan", name: "Ushering, Protocol & Follow Up Ministry", tagline: "First Impressions of God's House", description: "Dedicated to orderliness, warm hospitality, and diligent follow-up - ensuring every member and visitor feels the excellence of God's presence.", convener: "Eld. Dr. A. K. Allotey", units: ["Ushering", "Protocol", "Follow Up"], members: ["Eld. Dr. E. J. Okorie", "Eld. Mary Itobo", "Eld. Dr. Irene Ijoma"] },
      { id: "media", icon: "Monitor", style: "emerald", name: "Media, ICT, Library & Documentation Ministry", tagline: "Bridging Church and the Digital World", description: "End-to-end digital ministry: live streaming, social media, publications, documentation, and managing the parish library and bookshop resources.", convener: "Eld. Dr. E. Nkang", units: ["Media/ICT", "Publication", "Documentation", "Library", "Bookshop", "Kiosks"], members: ["Eld. Felix Onwuchekwa", "Eld. E. E. Esege", "Eld. Mrs. A. V. Ukpanyang", "Eld. Mike Ani Agwu"] },
      { id: "lovecare", icon: "Heart", style: "rose", name: "Love & Care Ministry", tagline: "Carrying One Another's Burdens", description: "Upholding the spiritual and physical welfare of Parish families - overseeing church arms, organisations, and supporting members through every season of life.", convener: "Most Rev. Mba Idika", units: ["Love and Care", "Welfare of Church Members", "Oversight of Church Arms & Organisations"], members: ["Eld. Mrs. Ogbonne Nnachi Ibiam", "Eld. Mrs. A. V. Ukpanyang", "Eld. Dr. Enefiok Asanga"] },
      { id: "family", icon: "Home", style: "blue", name: "Christian Home & Family Life Ministry", tagline: "Strengthening Every Home", description: "Walking with families through every stage of life - from pre-marriage preparation to post-marriage counselling and sustained family life balance.", convener: "Eld. Mrs. B. Umoga", units: ["Pre-Marriage Preparation", "Post Marriage Counselling", "Family Life Balance"], members: ["Eld. A. K. Allotey", "Eld. Dr. Enefiok Asanga", "Eld. Mrs. Ebere Ukandu"] },
      { id: "csr", icon: "HandHeart", style: "green", name: "Neighbourhood Intervention & Corporate Social Responsibility Ministry", tagline: "The Church in the Community", description: "Executing the church's social responsibility through scholarships, community programmes, and strategic interventions in the Wuse host community.", convener: "Rev. Mrs. Victoria Onu", units: ["Church CSR Programmes", "Host Community Scholarships", "Other Community Social Interventions"], members: ["Eld. Mary Itobo", "Eld. E. J. Okorie", "Eld. Mrs. Nkata"] },
      { id: "environment", icon: "Leaf", style: "teal", name: "Environment, Aesthetics & Sanctuary Keepers Ministry", tagline: "Keeping God's House in Excellence", description: "Maintaining the beauty, order and sanctity of the church environment - from landscaping and aesthetics to the dedicated sanctuary keepers team.", convener: "Eld. Otu Ekpenyong", units: ["Church Environment", "Beautification & Aesthetics", "Sanctuary Keepers"], members: ["Eld. Ugochi Chima", "Eld. Mrs. Ebere Ukandu", "Eld. Mike Oti"] },
    ],
    churchArms: [
